 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called Bitcoin Vault,
 * which enables instant payments to anyone, anywhere in the world. Bitcoin Vault uses peer-to-peer technology to operate:
